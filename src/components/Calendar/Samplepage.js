  ...
  return (
    <div className="container px-10 flex flex-col items-right gap-5 justify-center">
      ...
      <div className="mt-4 flex space-x-4">
        ...
        <button className="p-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200">
          Reject
        </button>
      </div>
    </div>
